...
* Flow
  ...
  - DB-də bu format saxlanır: salt.hash
...
* 📊 Reports Modulu (Vehicle Price Estimation)
  - Bu modul istifadəçilərin avtomobil satış report-larını yaratmasına və oxşar avtomobillər əsasında təxmini qiymət (estimate) hesablanmasına imkan verir.
  - Report → User ilə ManyToOne relation-dadır.
  - Bir user bir neçə report yarada bilər.
